...
<div class="container">
	...
	<tbody>
		...
		<tr>
			<td>
				<a href="<c:url value='/contaBancaria/'/>${conta.id}"><span title="Alterar"  class="glyphicon glyphicon-edit"></span></a>
				<a href="<c:url value='/contaBancaria/remove/'/>${conta.id}"><span title="Excluir" class="glyphicon glyphicon-remove"></span></a> 
			</td>
			<td>
