...
<div class="container">
	...
	<div class="panel panel-default">
  	<div class="panel-body">
	<div class="row">
		<div class="col-md-4"><b>Total compensado:</b> <fmt:formatNumber value="${totalCompensado}" minFractionDigits="2" type="number"/></div>
		<div class="col-md-4"><b>Total a compensar: </b><fmt:formatNumber value="${totalACompensar}" minFractionDigits="2" type="currency"/></div>
