...
<div class="container">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<form action="<c:url value='/contaFundoFixo/add'/>" id="formConta"
				...
				<div  class="row" id="divDadosBancarios">
					<div class="col-md-4">
						<label for="bean.banco">Unidade:</label> 
						<select id="bean.unidade.id" name="bean.unidade.id" class="selectpicker form-control required" data-live-search="true">
									<option value =""></option>
									<c:forEach var="unidade" items="${unidades}" varStatus="contador">
									
										<option value ="${unidade.id}" ${bean.unidade.id eq unidade.id ? 'selected' : ''}>${unidade.descricao}</option>
